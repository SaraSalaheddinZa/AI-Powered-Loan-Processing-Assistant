...
The following screenshots can be included as evidence for M7.

### Screenshot 1 --- Agent Testing

**\[Insert Screenshot --- Agentforce Preview / Test\]**

*Figure 7.1. Agentforce test showing the loan application conversation.*

### Screenshot 2 --- Flow Debug

**\[Insert Screenshot --- Flow Debug/Test\]**

*Figure 7.2. Flow debug used to verify the application creation
process.*

### Screenshot 3 --- UAT Result

**\[Insert Screenshot --- Successful UAT\]**

*Figure 7.3. End-to-end UAT result for the loan application process.*

### Screenshot 4 --- Security

**\[Insert Screenshot --- Object or Permission Settings\]**

*Figure 7.4. Salesforce access configuration reviewed for the Loan
Application object.*

### Screenshot 5 --- Field Security

**\[Insert Screenshot --- Field-Level Security\]**

*Figure 7.5. Field-level security reviewed for the Loan Application
fields.*
